...
HINT_NODES_BEST = 7000 -- node budget for the player's on-board hint; deeper than a live reply since it's computed once per move, not under time pressure - catches "good-looking but refuted next move" traps a shallow search misses
