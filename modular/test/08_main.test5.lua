...
-- Umesto statičke evaluacije, pokreni kratki search za tačniji score
local _, searchScore, _, _, _ = search(pos, 300, gameHistory)
setEngineScore(searchScore or peekScore)  -- <--- OVO JE POPRAVKA
