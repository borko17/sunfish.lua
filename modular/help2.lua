...
function showHelpCommon()
   ...
   print("• Empty squares:  : light . dark")
   print("")
   echoW("BOARD STYLE ('c' toggle):")
   print("-------------")
   print("Classic (default):")
   print("• Bordered board, letter/unicode")
   print("  squares as above")
   print("")
   print("Fancy (shaded):")
   print("• Squares shown as ▓ dark / ░ light")
   print("  blocks instead of dot symbols")
   print("• Pieces always use the SAME filled")
   print("  glyph regardless of side (no color")
   print("  in this terminal to tell them apart")
   print("  by outline vs filled) -- rely on")
   print("  the board position / markers")
   print("")
   echoW("DEFAULT CONFIGURATION can be changed in CONFIG - section at top of LUA script:")
   print("-------------")
   print("USE_UNICODE_PIECES = true/false")
   print("USE_FANCY_BOARD = true/false")
...
function showHelpGame()
   ...
   print("'c' - Toggle board style")
   print("    • Classic (bordered) <-> Fancy")
   print("      (shaded ▓░ squares).")
...
function showHelpPuzzle()
   ...
   print("'c' - Toggle board style (classic/fancy)")
   print("'a' - Toggle annotations")
   print("'u' - Check sunfish.lua for updates")
   print("'h' - Show this help screen")
   print("'?' - Show About screen")
...
function showHelpChallenge()
   ...
   print("")
   print("• All other commands work the same as in a normal game (s/sN/l/m/h/a/c/d/u/?)")
   print("")
...
function showAbout()
   ...
   print("• Classic (bordered) or fancy (shaded ▓░)")
   print("  board style")
